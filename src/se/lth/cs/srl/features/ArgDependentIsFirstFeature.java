...
public class ArgDependentIsFirstFeature extends AttrFeature {
	private static final long serialVersionUID = 1L;

	protected ArgDependentIsFirstFeature(FeatureName name, WordData attr, TargetWord tw, String POSPrefix) {
